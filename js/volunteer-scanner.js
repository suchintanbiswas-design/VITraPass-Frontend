/**
 * Protected Scanner page logic for Volunteers.
  ...
  async function validateTicket(qrData) {
    ...
    try {
      ...
      if (response.status === 401 || response.status === 403) {
        showResult('error', '<h3>✕ AUTHORIZATION FAILED</h3><p>You do not have permission to validate tickets. Please log in as a volunteer.</p>');
